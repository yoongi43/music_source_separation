    ...
    def forward(self, wav):
        ...
        if self.shift > 0:
            if not self.training:
                ...
                # print('shft', wav.shape)  # (b, src, channel, length)
                wav = wav.gather(3, indexes + offsets)
        # print('shift', wav.shape)
        return wav
